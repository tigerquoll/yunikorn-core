...
// belong to. A comment above a single "var" attaches to the declaration rather than to the
// variable, and the analysis reads it from the variable, so the annotation would be dropped
